...
<html lang="es">
  <head>
    ...
    function selectAnioInicio(str){
        ...
        urlRequestEstaciones = "php_getAnioServicioConsultaEstadoInicio.php?estado=" + estado + "&tipo=" + tipoConsulta;
    ...
    function selectMonthInicio(str){
        ...
        urlRequestEstaciones = "php_getMesServicioConsultaEstadoInicio.php?estado=" + estado + "&estacion=" + estacion + "&anioInicio=" + anioInicio + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
    ...
    function selectAnioFin(str){
        mesInicio = str;
        urlRequestEstaciones = "php_getAnioServicioConsultaEstadoFin.php?estado=" + estado + "&estacion=" + estacion + "&anioInicio=" + anioInicio + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
    ...
    function selectMonthFin(str){
        anioFin = str;
        urlRequestEstaciones = "php_getMesServicioConsultaEstadoFin.php?estado=" + estado + "&estacion=" + estacion + "&anioFin=" + anioFin + "&mesInicio=" + mesInicio + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
    ...
    function displayInfo(str){
        mesFin = str;
        urlRequestEstaciones = "php_getServicioConsultaEstadoInfo.php?estado=" + estado + "&anioInicio=" + anioInicio +"&anioFin=" + anioFin + "&mesInicio=" + mesInicio + "&mesFin=" + mesFin + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
        ...
        <body>
            <div class="container">
                <form class="form-horizontal" role="form" action="#" method="post">
                    ...
                    <div class="form-group">
                            <label for="estado">Estado:</label>
                            <select id="estado" onchange="selectAnioInicio(this.value)" class="form-control" name="estado">
                            </select> 
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
