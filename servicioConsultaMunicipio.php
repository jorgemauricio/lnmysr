...
<html lang="es">
  <head>
    ...
    function selectAnioInicio(str){
        municipio = str;
        urlRequestEstaciones = "php_getAnioServicioConsultaMunicipioInicio.php?estado=" + estado + "&municipio=" + municipio + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
    ...
    function selectMonthInicio(str){
        ...
        urlRequestEstaciones = "php_getMesServicioConsultaMunicipioInicio.php?estado=" + estado + "&municipio=" + municipio + "&anioInicio=" + anioInicio + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
    ...
    function selectAnioFin(str){
        mesInicio = str;
        urlRequestEstaciones = "php_getAnioServicioConsultaMunicipioFin.php?estado=" + estado + "&municipio=" + municipio + "&anioInicio=" + anioInicio + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
    ...
    function selectMonthFin(str){
        anioFin = str;
        urlRequestEstaciones = "php_getMesServicioConsultaMunicipioFin.php?estado=" + estado + "&municipio=" + municipio + "&anioFin=" + anioFin + "&mesInicio=" + mesInicio + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
    ...
    function displayInfo(str){
        mesFin = str;
        urlRequestEstaciones = "php_getServicioConsultaMunicipioInfo.php?estado=" + estado + "&municipio=" + municipio + "&anioInicio=" + anioInicio +"&anioFin=" + anioFin + "&mesInicio=" + mesInicio + "&mesFin=" + mesFin + "&tipo=" + tipoConsulta;
        if (window.XMLHttpRequest) {
            // code for IE7+, Firefox, Chrome, Opera, Safari
            xmlhttp = new XMLHttpRequest();
        } else {
            ...
            <div class="container">
                <form class="form-horizontal" role="form" action="#" method="post">
                    ...
                    <div class="form-group">
                            ...
                            <select id="municipio" onchange="selectAnioInicio(this.value)" class="form-control" name="municipio">
