<?php
    ...
    if ($tipo == "p_diario") {
        ...
        $query  = "SELECT extract(year from estado".$estado.".fecha) as anio from estado".$estado." inner join estaciones on estado".$estado.".numero=estaciones.numero where estaciones.municipioid=".$municipio." group by extract(year from estado".$estado.".fecha) order by extract(year from estado".$estado.".fecha) asc";
    }
