<?php
    ...
    // Query 
    if ($tipo == "p_diario") {
        $query = "select * from estado".$estado."diarios inner join estaciones on estado".$estado."diarios.numero=estaciones.numero where estaciones.municipioid=".$municipio." and estado".$estado."diarios.fecha between '".$anioInicio."-".$mesInicio."-01' and '".$anioFin."-".$mesFin."-".lastDayOfMonth($mesFin)."' order by estado".$estado."diarios.numero, estado".$estado."diarios.fecha asc";
